...
#example: qsub mouseTCR.sh fastq outputPrefix user

bwa mem /home/$3/data/mouseTCR/mouseTCR.fa $2_Read1.fastq $2_TCRreadFinal.fastq | samtools view -hF 256 > $2_TCRalign.sam
